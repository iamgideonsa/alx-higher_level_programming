...
This project was done during **ALX SE Studies** at **ALX School**. The end game is to learn about exceptions and how to use them, errors, and how to raise them in **Python**.
