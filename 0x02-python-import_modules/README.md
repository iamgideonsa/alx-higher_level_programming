...
This project was done during **ALX SE Studies** at **ALX School**. The end game is to know how to import functions, create modules and use command line arguments in **Python**.
